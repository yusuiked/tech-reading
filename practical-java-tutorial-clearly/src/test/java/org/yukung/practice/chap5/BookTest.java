...
public class BookTest {
	...
	public void testEquals() {
		...
		another.setComment("こめんと"); // 全てのフィールドが等価対象
		...
		Book failure3 = new Book();
		failure3.setTitle("スッキリわかるJava入門実践編");
		failure3.setPublishDate(calendar.getTime());
		failure3.setComment("コメント");	// コメントが違う
